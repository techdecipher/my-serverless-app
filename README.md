...
```bash
my-serverless-app$ make build
my-serverless-app$ make deploy.guided
```
...
```bash
my-serverless-app$ make run
my-serverless-app$ curl http://localhost:3000/hello
```
...
```bash
my-serverless-app$ sam logs -n HelloWorldFunction --stack-name <Name-of-your-deployed-stack> --tail
```
...
```bash
my-serverless-app$ make dev
my-serverless-app$ make test
```
...
```bash
my-serverless-app$ aws cloudformation delete-stack --stack-name my-serverless-app
```
...
```bash
my-serverless-app$ pipenv lock -r > hello_world/requirements.txt
```
